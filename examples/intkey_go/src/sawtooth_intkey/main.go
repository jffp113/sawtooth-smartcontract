...
type Opts struct {
	Threshold       int    `short:"t" long:"threshold" description:"Threshold of signers" default:"3"`
	NumberOfSigners int    `short:"n" long:"number" description:"Number of signers" default:"5"`
	Scheme			string	`short:"s" long:"scheme" description:"Scheme used to sign" default:"TBLS256"`
...
func main() {
	...
	handler := intkey.NewIntkeyHandler(prefix,opts.Threshold,opts.NumberOfSigners,opts.Scheme)
